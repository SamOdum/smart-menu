					...
					<div className="col-md-3 col-sm-4 col-xs-3">
						...
						<div className="mega-container visible-lg visible-md visible-sm">
							<div className="navleft-container">
								...
								<div className="mega-menu-category" style={priMenuOpen ? {display: 'block'} : {display: 'none'}}>
									<ul className="nav">
										<li className={secMenuOpen.firstOne ? 'active' : ''} data-id='firstOne' onMouseEnter={handleSecMenuOpen} onMouseLeave={handleSecMenuClose} >
											<a href="#234bcde1234abc">
											<i className="icon fa fa-female fa-fw"></i> Women
											</a>
											<div className="wrap-popup" onMouseEnter={()=>keepSecMenuOpen('firstOne')} >
												<div className="popup">
													<div className="row">
														...
														<div className="col-md-4 col-sm-6 has-sep">
															...
															<ul className="nav">
																<li>
																	<a href="shop_grid.html">Tandoor & Grills</a>
																</li>
																<li>
										...
										<li className={secMenuOpen.secondOne ? 'active' : ''} data-id='secondOne' onMouseEnter={handleSecMenuOpen} onMouseLeave={handleSecMenuClose} >
											<a href="#234bcde" >
											<i className="icon fa fa-male fa-fw"></i> Men
											</a>
											<div className="wrap-popup" onMouseEnter={()=>keepSecMenuOpen('secondOne')} >
												<div className="popup">
													<div className="row">
														<div className="col-md-4 col-sm-6">
															<ul className="nav">
										...
										<li className="nosub">
											<a href="#14558">
											<i className="icon fa fa-camera fa-fw"></i> Electronics
											</a>
										</li>
										<li className={secMenuOpen.fourthOne ? 'active' : ''} data-id='fourthOne' onMouseEnter={handleSecMenuOpen} onMouseLeave={handleSecMenuClose} >
											<a href="shop_grid.html">
												<i className="icon fa fa-linux fa-fw"></i> Kids
												</a>
												<div className="wrap-popup column2" onMouseEnter={()=>keepSecMenuOpen('fourthOne')} >
													<div className="popup">
														<div className="row">
															<div className="col-sm-6">
																...
																<ul className="nav">
																	<li>
																		<a href="shop_grid.html"> Kids' Beds </a>
																	</li>
																	<li>
																		<a href="shop_grid-2.html">
																			Wall Stickers
																		</a>
																	</li>
																	<li>
